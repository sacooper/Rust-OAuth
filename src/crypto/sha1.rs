...
mod tests {
    ...
    fn sha1_test1(){
        ...
        assert_eq!(sha1(test), [0x81u8, 0xfeu8, 0x8bu8, 0xfeu8, 0x87u8,
    ...
    fn sha1_test2(){
        ...
        assert_eq!(sha1(test), [0xf6u8, 0x51u8, 0x36u8, 0x40u8, 0xf3u8,
    ...
    fn sha1_test3(){
        ...
        assert_eq!(sha1(test), [0x49u8, 0x56u8, 0xe9u8, 0x28u8, 0x66u8,
    ...
    fn sha1_test4(){
        ...
        assert_eq!(sha1(test), [0xdau8, 0xc2u8, 0x3cu8, 0x13u8, 0x66u8,
    ...
    fn sha1_test5(){
        ...
        assert_eq!(sha1(test), [0x23u8, 0xcau8, 0x04u8, 0x35u8, 0xedu8,
